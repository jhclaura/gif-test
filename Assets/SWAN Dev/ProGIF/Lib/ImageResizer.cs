...
public class ImageResizer
{
	...
	public Texture2D ResizeTexture(Texture2D texOrigin, int width, int height)
	{
		...
		//		if (texOrigin.width < texOrigin.height)
		//			iW = (int)((float)texOrigin.width / texOrigin.height * width);
		//		else if (texOrigin.height < texOrigin.width)
		//			iH = (int)((float)texOrigin.height / texOrigin.width * height);
