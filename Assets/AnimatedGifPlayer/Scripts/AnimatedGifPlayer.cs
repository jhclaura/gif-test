...
namespace OldMoatGames {
    ...
    public class AnimatedGifPlayer : MonoBehaviour {
        ...
        // LAURAAA
        // can't make it work with Texture2D.LoadRawTextureData :/
        public bool CreateMipMap = false;
        ...
        public System.Action OnAllFramesRead;
        ...
        private void CreateTargetTexture() {
            ...
            GifTexture = CreateTexture(_gifDecoder.GetFrameWidth(), _gifDecoder.GetFrameHeight(), CreateMipMap);
        ...
        // Used to set the frame target in the target component (note: didn't used)
        private void SetTargetTexture() {
            if (GifTexture == null || GifTexture.width != _gifDecoder.GetFrameWidth() ||
                ...
                GifTexture = CreateTexture(_gifDecoder.GetFrameWidth(), _gifDecoder.GetFrameHeight(), false);   // Lauraaa
        ...
        private static Texture2D CreateTexture(int width, int height, bool _doMipmap) {
            return new Texture2D(width, height, TextureFormat.RGBA32, _doMipmap);
        }
